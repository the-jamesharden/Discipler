...
Three things, and nothing else: the availability overlay, the material assigned to each relationship, and the name and phone number of everyone in it. No message history, no analytics, no ability to edit anyone else's data.
